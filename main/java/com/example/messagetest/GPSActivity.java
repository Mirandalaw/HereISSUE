...
public class GPSActivity extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapReverseGeoCoder.ReverseGeoCodingResultListener {
    ...
    public void onRequestPermissionsResult(int permsRequestCode,
        ...
        if (permsRequestCode == PERMISSIONS_REQUEST_CODE && grandResults.length == REQUIRED_PERMISSIONS.length) {
            ...
            if (check_result) {
                Log.d("@@@", "start");
                //위치 값을 가져올 수 있음
                //TrackingModeOnWithout하면 트래킹 모드가 꺼짐
